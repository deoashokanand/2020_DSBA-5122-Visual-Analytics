...
author: "Ashokanand Deo, Jennifer Wolf, Halima Barthe and Tristan Richard"
date: "12/14/2020"
...
His analysis visualized Canadian Wind turbine data from 1993 - 2019 by height, by year, household consumption, and turbine production. The plots are useful for those subsets of data but are limited in the ability to make deeper connections or draw meaningful conclusions from amoung the plots. 
...
The final project, Candian Wind Turbine Shiny App, is published here: https://jwolf15.shinyapps.io/final_project/.
